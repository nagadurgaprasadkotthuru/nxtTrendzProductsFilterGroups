...
class AllProductsSection extends Component {
  ...
  onChangeCategory = category => this.setState({category}, this.getProducts)

  onChangeRating = rating => this.setState({rating}, this.getProducts)
      ...
      return (
        <div className="no-products-container">
          ...
          <p className="no-products-description">
            We could find any products. Try other filters.
          </p>
        </div>
      )
    }
  ...
  renderFailureView = () => (
    <div className="no-products-container">
      ...
      />
      <h2 className="no-products-heading">Oops! Something Went Wrong</h2>
      <p className="no-products-description">
